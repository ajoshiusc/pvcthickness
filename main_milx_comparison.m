...
pial=readdfs([subbasename,'.pial.cortex.dfs']);

inner=readdfs([subbasename,'.inner.cortex.dfs']);

midmid.faces=inner.faces;
midmid.vertices=0.75*inner.vertices+0.25*pial.vertices;

writedfs([subbasename,'.midmid.cortex.dfs'],midmid);
...
%%
pvcth=readdfs('/big_disk/ajoshi/milx_cloud_results/milxcloud_results/BrainSuite/BCI_DNI_brain_deface_MNI.pvc-thickness_0-6mm.mid.cortex.dfs');
...
writedfs([subbasename,'.midmid.cortex.pvcth.dfs'], midmid);
