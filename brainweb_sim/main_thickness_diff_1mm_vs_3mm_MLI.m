...
sl=readdfs([pth1mm,'/atlas_MLIthickness.left.mid.cortex.svreg.dfs']);
%smooth_surf_function(sl,sl.attributes);
thickness_1mm = sl.attributes;

sl=readdfs([pth3mm,'/atlas_MLIthickness.left.mid.cortex.svreg.dfs']);
%smooth_surf_function(sl,sl.attributes);
...
saveas(h,'MLI_left_brainweb_1.png')
view(90,0);camlight('headlight'); 
saveas(h,'MLI_left_brainweb_2.png')
close all;


save 3mm_1mm_left_MLI
