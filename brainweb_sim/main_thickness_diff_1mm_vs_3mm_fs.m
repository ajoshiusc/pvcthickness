...
sl=readdfs([pth1mm,'/atlas_fs_thickness.right.mid.cortex.svreg.dfs']);
...
sl=readdfs([pth3mm,'/atlas_fs_thickness.right.mid.cortex.svreg.dfs']);
%smooth_surf_function(sl,sl.attributes);
...
saveas(h,'FS_right_brainweb_1.png')
view(90,0);camlight('headlight'); 
saveas(h,'FS_right_brainweb_2.png')
close all;

save 3mm_1mm_right_fs
