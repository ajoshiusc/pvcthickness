...
saveas(h,'thickness1_PVC_left1.png');
autocrop_img('thickness1_PVC_left1.png');
view(-90,0);camlight('headlight');material dull;
saveas(h,'thickness1_PVC_left2.png');
autocrop_img('thickness1_PVC_left2.png');



% plot right hemisphere

pvc_val = (1-0.2)*sr.attributes
...
axis on;axis equal;caxis([0,2]);axis off;
view(90,0);camlight('headlight');material dull;
saveas(h,'thickness1_PVC_right1.png');
autocrop_img('thickness1_PVC_right1.png');
view(-90,0);camlight('headlight');material dull;
saveas(h,'thickness1_PVC_right2.png');
autocrop_img('thickness1_PVC_right2.png');
