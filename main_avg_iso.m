...
for jj=1:length(lst)
    ...
    if (exist([['/home/ajoshi/for_shravanr/',lst(jj).name, '/atlas'], '.iso-thickness_0-6mm.left.mid.cortex.dfs'],'file') )
        aa1=aa1+1;
        %split_thickness_map(['/home/ajoshi/for_shravanr/',lst(jj).name, '/mprage_anonymized']);
        s=readdfs([subbasename, '.iso-thickness_0-6mm.left.mid.cortex.dfs']);
        ...
        s=readdfs([subbasename, '.iso-thickness_0-6mm.right.mid.cortex.dfs']);
        if (aa1==1)
...
saveas(h,'avg_thickness_mappedl_iso.fig');
view(-90,30);camlight('headlight');material dull;
saveas(h,'avg_thickness_mappedl_1_iso.png');
view(90,0);camlight('headlight');material dull;
saveas(h,'avg_thickness_mappedl_2_iso.png');
...
saveas(h,'avg_thickness_mappedr_iso.fig');
view(-90,0);camlight('headlight');material dull;
saveas(h,'avg_thickness_mappedr_1_iso.png');
view(90,30);camlight('headlight');material dull;
saveas(h,'avg_thickness_mappedr_2_iso.png');
...
colormap(aa);
view(-90,30);camlight('headlight');material dull;
saveas(h,'avg_thickness_left_iso_continuous_1.png');
view(90,0);camlight('headlight');material dull;
saveas(h,'avg_thickness_left_iso_continuous_2.png');
...
colormap(aa);
view(-90,0);camlight('headlight');material dull;
saveas(h,'avg_thickness_right_iso_continuous_1.png');
view(90,30);camlight('headlight');material dull;
saveas(h,'avg_thickness_right_iso_continuous_2.png');
