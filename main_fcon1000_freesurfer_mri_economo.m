...
for j=1:length(l)
    ...
    if exist([subdir,'/surf/rh.thickness.fwhm10.fsaverage.mgh'],'file')
        ...
        unix('mris_anatomical_stats -a ${SUBJECTS_DIR}/${SUBJECTNAME}/label/lh.economo.annot -f ${SUBJECTS_DIR}/${SUBJECTNAME}/stats/lh.economo.stats ${SUBJECTNAME} lh');
        unix('mris_anatomical_stats -a ${SUBJECTS_DIR}/${SUBJECTNAME}/label/rh.economo.annot -f ${SUBJECTS_DIR}/${SUBJECTNAME}/stats/rh.economo.stats ${SUBJECTNAME} rh');
