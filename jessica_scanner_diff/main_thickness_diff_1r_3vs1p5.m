...
for jj=1:5
    ...
    if scanno1>1
        ...
        saveas(h,sprintf('std_dev_thickness_ALE1_sub%d_r_13m1p5t_left2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_ALE1_sub%d_r_13m1p5t_left2.png',jj));
        view(-90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_ALE1_sub%d_r_23m1p5t_left2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_ALE1_sub%d_r_23m1p5t_left2.png',jj));
        ...
        axis on;axis equal;caxis([-.75,.75]);axis off;
        view(90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LE1_sub%d_r_13m1p5t_left2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LE1_sub%d_r_13m1p5t_left2.png',jj));
        view(-90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LE1_sub%d_r_23m1p5t_left2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LE1_sub%d_r_23m1p5t_left2.png',jj));
        ...
        axis on;axis equal;caxis([-.75,.75]);axis off;
        view(90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LD1_sub%d_r_13m1p5t_left2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LD1_sub%d_r_13m1p5t_left2.png',jj));
        view(-90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LD1_sub%d_r_23m1p5t_left2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LD1_sub%d_r_23m1p5t_left2.png',jj));
        ...
        view(90,0);camlight('headlight');material dull;
        saveas(h,sprintf('diff_thickness_FS_sub%d_l_13m1p5t_left2.png',jj));
        autocrop_img(sprintf('diff_thickness_FS_sub%d_l_13m1p5t_left2.png',jj));
        view(-90,0);camlight('headlight');material dull;
        saveas(h,sprintf('diff_thickness_FS_sub%d_l_23m1p5t_left2.png',jj));
        autocrop_img(sprintf('diff_thickness_FS_sub%d_l_23m1p5t_left2.png',jj));
