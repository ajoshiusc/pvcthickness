...
for jj=3
        ...
        for ii=1:length(ll2)
            ...
            for ww=1:min(1,length(subdir))
                ...
                if exist([subbasename,'.pvc-thickness_0-6mm.right.mid.cortex.dfs'],'file')
                    ...
                    thicknessr(:,scanno1)=smooth_surf_function(sr,sr.attributes);
                    
                    sriso=readdfs([pth,'/atlas.iso-thickness_0-6mm.right.mid.cortex.dfs']);
                    thicknessriso(:,scanno1)=smooth_surf_function(sriso,sriso.attributes);
                    
                    srld=readdfs([pth,'/atlas.right.mid.cortex.svreg.dfs']);
                    thicknessrld(:,scanno1)=smooth_surf_function(sr,srld.attributes);
    ...
    if scanno1>1
        ...
        saveas(h,sprintf('std_dev_thickness_ALE1_sub%d_r_1ge_si.png',jj));
        autocrop_img(sprintf('std_dev_thickness_ALE1_sub%d_r_1ge_si.png',jj));
        view(-90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_ALE1_sub%d_r_2ge_si.png',jj));
        autocrop_img(sprintf('std_dev_thickness_ALE1_sub%d_r_2ge_si.png',jj));
        ...
        axis on;axis equal;caxis([-1,1]);axis off;
        view(90,30);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LE1_sub%d_r_1ge_si.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LE1_sub%d_r_1ge_si.png',jj));
        view(-90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LE1_sub%d_r_2ge_si.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LE1_sub%d_r_2ge_si.png',jj));
        ...
        axis on;axis equal;caxis([-1,1]);axis off;
        view(90,30);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LD1_sub%d_r_1ge_si.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LD1_sub%d_r_1ge_si.png',jj));
        view(-90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LD1_sub%d_r_2ge_si.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LD1_sub%d_r_2ge_si.png',jj));
