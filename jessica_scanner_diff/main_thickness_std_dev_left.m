...
for jj=1:6
        ...
        for ii=1:length(ll2)
            ...
            for ww=1:length(subdir)
                ...
                if exist([subbasename,'.pvc-thickness_0-6mm.left.mid.cortex.dfs'],'file')
                    ...
                    thicknessrld(:,scanno1)=smooth_surf_function(srld,srld.attributes);
    ...
    if scanno1>1
        ...
        saveas(h,sprintf('std_dev_thickness_ALE_sub%d_l_1.png',jj));
        autocrop_img(sprintf('std_dev_thickness_ALE_sub%d_l_1.png',jj));
        view(-90,30);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_ALE_sub%d_l_2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_ALE_sub%d_l_2.png',jj));
        ...
        axis on;axis equal;caxis([0,1]);axis off;
        view(90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LE_sub%d_l_1.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LE_sub%d_l_1.png',jj));
        view(-90,30);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LE_sub%d_l_2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LE_sub%d_l_2.png',jj));
        ...
        axis on;axis equal;caxis([0,1]);axis off;
        view(90,0);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LD_sub%d_l_1.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LD_sub%d_l_1.png',jj));
        view(-90,30);camlight('headlight');material dull;
        saveas(h,sprintf('std_dev_thickness_LD_sub%d_l_2.png',jj));
        autocrop_img(sprintf('std_dev_thickness_LD_sub%d_l_2.png',jj));
