...
saveas(h,'avg_thickness_mappedl.fig');
view(-90,30);camlight('headlight');material dull;
saveas(h,'avg_thickness_mappedl_1.png');
view(90,0);camlight('headlight');material dull;
saveas(h,'avg_thickness_mappedl_2.png');
...
saveas(h,'avg_thickness_mappedr.fig');
view(-90,0);camlight('headlight');material dull;
saveas(h,'avg_thickness_mappedr_1.png');
view(90,30);camlight('headlight');material dull;
saveas(h,'avg_thickness_mappedr_2.png');
...
colormap(aa);
view(-90,30);camlight('headlight');material dull;
saveas(h,'avg_thickness_left_pvc_continuous_1.png');
view(90,0);camlight('headlight');material dull;
saveas(h,'avg_thickness_left_pvc_continuous_2.png');
...
colormap(aa);
view(-90,0);camlight('headlight');material dull;
saveas(h,'avg_thickness_right_pvc_continuous_1.png');
view(90,30);camlight('headlight');material dull;
saveas(h,'avg_thickness_right_pvc_continuous_2.png');
