...
for jj=1:size(mapped_thickness_l,2)
    mapped_thickness_r_mapped2_l(:,jj)=smooth_surf_function(smidltar1,mapped_thickness_r_mapped2_l(:,jj),15,15);
    mapped_thickness_l(:,jj)=smooth_surf_function(smidltar1,mapped_thickness_l(:,jj),15,15);
jj
end

save left_mapped2_right_fcon1000_pvc_smooth2;
...
saveas(h,'mapped_thickness_r_mapped2_l_pvc_1_smooth2.png');view(90,0);camlight('headlight');
saveas(h,'mapped_thickness_r_mapped2_l_pvc_2_smooth2.png');
...
saveas(h,'mapped_thickness_r_mapped2_l_pvc_1_smooth_diff2.png');view(90,0);camlight('headlight');
saveas(h,'mapped_thickness_r_mapped2_l_pvc_2_smooth_diff2.png');
