...
for jj=1:length(lst)
    ...
    if (exist(['/home/ajoshi/for_shravanr/',lst(jj).name,'/atlas.iso-thickness_0-6mm.left.mid.cortex.dfs'],'file') && exist([subbasename,'.left.mid.cortex.svreg.dfs'],'file'))  

       sl=readdfs(['/home/ajoshi/for_shravanr/',lst(jj).name,'/atlas.left.mid.cortex.svreg.dfs']);       
       sr=readdfs(['/home/ajoshi/for_shravanr/',lst(jj).name,'/atlas.right.mid.cortex.svreg.dfs']);       
...
save left_mapped2_right_fcon1000_linked;
...
save left_mapped2_right_fcon1000_linked_smooth;
...
saveas(h,'mapped_thickness_r_mapped2_l_linked_1_smooth.png');view(90,0);camlight('headlight');
saveas(h,'mapped_thickness_r_mapped2_l_linked_2_smooth.png');
...
saveas(h,'mapped_thickness_r_mapped2_l_linked_1_smooth_diff.png');view(90,0);camlight('headlight');
saveas(h,'mapped_thickness_r_mapped2_l_linked_2_smooth_diff.png');
