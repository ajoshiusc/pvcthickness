...
function split_thickness_map_Thr_iso(subbase,Thr)

inner=readdfsGz([subbase, '.inner.cortex.dfs']);
pial=readdfsGz([subbase, '.pial.cortex.dfs']);
th=readdfs([subbase, ['.pvc-thickness_Thr_iso',int2str(Thr),'_0-6mm.mid.cortex.dfs']]);
...
writedfs([subbase, ['.pvc-thickness_Thr_iso',int2str(Thr),'_0-6mm.left.mid.cortex.dfs']],mid_l);
...
writedfs([subbase, ['.pvc-thickness',int2str(Thr),'_0-6mm.right.mid.cortex.dfs']],mid_r);
