function map_pvcthickness2atlas(subbasename)        

        s=readdfs([subbasename,'.heateq_pvc.mid.cortex.dfs']);
        ...
        writedfs([pth1,'/atlas_pvcthickness.left.mid.cortex.svreg.dfs'],smidltar);
        writedfs([pth1,'/atlas_pvcthickness.right.mid.cortex.svreg.dfs'],smidrtar);
