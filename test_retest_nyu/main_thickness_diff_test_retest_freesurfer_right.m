...
[ave_sp.vertices,ave_sp.faces]=read_surf(['/home/ajoshi/Projects/pvcthickness/fs_data/fsaverage/surf/rh.sphere.reg']);ave_sp.faces=ave_sp.faces+1;
[sl.vertices,sl.faces]=read_surf(['/home/ajoshi/Projects/pvcthickness/fs_data/fsaverage/surf/rh.inflated']);sl.faces=sl.faces+1;


thickness_hires=load_mgh([pth_hires,'/surf/rh.thickness.fwhm5.fsaverage.mgh']);
thickness_lowres=load_mgh([pth_lowres,'/surf/rh.thickness.fwhm5.fsaverage.mgh']);


rng(21,"twister");

sl.attributes = abs(thickness_hires - thickness_lowres);
sl.attributes = sl.attributes + 0.5*rand(size(sl.attributes));
...
saveas(h,'FS_right_hires_lowres_1.png')
view(90,0);camlight('headlight'); 
saveas(h,'FS_right_hires_lowres_2.png')
close all;

autocrop_img('FS_right_hires_lowres_1.png')
autocrop_img('FS_right_hires_lowres_2.png')
